...
return (
    <div style={{ position: 'absolute', top: '5px', left: '5px',width: '320px', height: '240px', border: '2px solid #222', borderRadius: '10px', overflow: 'hidden', position: 'relative', backgroundColor: '#000' }}>
